...
export function EmbedFormModal({ isOpen, onClose, formId }: EmbedFormModalProps) {
  const [copied, setCopied] = useState(false)

  if (!isOpen) return null

  const embedCode = `<iframe src="${process.env.NEXT_PUBLIC_BASE_URL}/forms/${formId}" width="100%" height="500px" frameborder="0"></iframe>`
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="relative w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
        ...
        <h2 className="mb-4 text-xl font-bold text-[#7c5cff]">Embed Form</h2>
        <p className="mb-6 text-gray-600">Copy and paste this code to display the form on your site.</p>
