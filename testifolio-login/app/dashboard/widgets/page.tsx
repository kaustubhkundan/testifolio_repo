  ...
  const testimonials = [
    {
      id: 1,
      name: "Sara Johnson",
      position: "Product Manager at Twitter",
    ...
    },
    {
      ...
      position: "Design Lead at LinkedIn",
    ...
    },
    {
      id: 4,
      name: "David Kim",
      position: "Engineering Manager at Instagram",
    ...
    },
    {
      id: 5,
      name: "Lisa Thompson",
      position: "Marketing Director at Facebook",
    ...
    },
    {
      id: 6,
      name: "James Wilson",
      position: "Design Lead at Twitter",
    ...
    <DashboardLayout>
      <div className="p-6">
        ...
        {!showCustomizer ? (
          ...
          <WidgetCustomizer onClose={() => setShowCustomizer(false)} testimonials={testimonials} />
        )}
      </div>
