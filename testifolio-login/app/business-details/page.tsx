      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-12 md:px-12 lg:px-16">
        <div className="w-full max-w-md">
          ...
          <form className="space-y-6">
            ...
            <Link
              href="/goals"
              className="block w-full rounded-md bg-[#b69df8] px-4 py-3 text-center text-base font-medium text-white hover:bg-[#a58af6] focus:outline-none focus:ring-2 focus:ring-[#b69df8] focus:ring-offset-2"
            >
              Continue
            </Link>
          </form>
